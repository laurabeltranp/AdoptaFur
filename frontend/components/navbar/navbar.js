          ...
          <Container fluid>
              ...
              <Nav>
                ...
                <NavDropdown title="Adoptar" id="basic-nav-dropdown">
                    <NavDropdown.Item href="/comoAdoptar">¿Cómo adoptar?</NavDropdown.Item>
                    <NavDropdown.Item href="/sobreNosotros">Sobre Nosotros</NavDropdown.Item>
                    <NavDropdown.Item href="/historiasFelices">Historias felices</NavDropdown.Item>
                </NavDropdown>
                <Nav.Link className="nav-link" href="/companerosDisponibles">Compañeros Disponibles</Nav.Link>
