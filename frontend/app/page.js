  ...
  return (
    <main>
      <section className="seccion1">
        <div className="container tarjetas-container">
          <div className="row">
            <div className="col-md-12">
              <h2 className="centered-text">Animales Destacados</h2>
            </div>
          </div>
          <div className="row mt-5">
            <div className="col-md-3">
              <div className="card h-100 tarjeta-background">
                <img src="/perrodestacado1.jpeg" className="card-img-top img-fluid" alt="Perro" />
            ...
            <div className="col-md-3">
              <div className="card h-100 tarjeta-background">
                <img src="/perrodestacado1.jpeg" className="card-img-top img-fluid" alt="Gato" />
                <div className="card-body">
            ...
            <div className="col-md-3">
              <div className="card h-100 tarjeta-background">
                <img src="/perrodestacado1.jpeg" className="card-img-top img-fluid" alt="Periquito" />
                <div className="card-body">
            ...
            <div className="col-md-3">
              <div className="card h-100 tarjeta-background">
                <img src="/perrodestacado1.jpeg" className="card-img-top img-fluid" alt="Cobaya" />
                <div className="card-body">
        ...
        <div className="row mt-5">
          <div className="col-md-12 text-center">
            <a href="#" className="btn btn-primary">ADOPTA</a>
          </div>
        </div>
      </section>
      ...
      <section className="seccion2 mt-5">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none">
          <defs>
            <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" style={{ 'stop-color': 'rgb(88,213,92)', 'stop-opacity': '0' }} />
              <stop offset="100%" style={{ 'stop-color': 'rgb(88,213,92)', 'stop-opacity': '1' }} />
            </linearGradient>
            <linearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" style={{ 'stop-color': ' rgb(255,255,255)', 'stop-opacity': '0' }} />
              <stop offset="100%" style={{ 'top-color': 'rgb(177,215,182)', 'stop-opacity': '1' }} />
            </linearGradient>
          </defs>
        ...
        <div className="container">
          ...
          <div className="row mt-5">
            <div className="col-md-12 text-center">
              <a href="comoAdoptar.html" className="btn btn-primary">Más información</a>
            </div>
          </div>
        </div>
      </section>

      <section className="seccion3 mt-5 mb-4">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none">
          <defs>
            <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" style={{ 'stop-color': 'rgb(88,213,92)', 'stop-opacity': '0' }} />
                ...
                <div className="carousel-inner">
                  <div className="carousel-item active">
                    <div className="row">
                      <div className="col">
                        <div className="card">
                          <img src="/IMG/gato4.jpg" className="card-img-top img-fluid" alt="Farruko" />
                          <div className="card-body">
                  ...
                  <div className="carousel-item">
                    <div className="row">
                      <div className="col">
                        <div className="card">
                          <img src="/IMG/cobayaseccion3.jpg" className="card-img-top img-fluid" alt="Cuquita" />
                          <div className="card-body">
                  ...
                  <div className="carousel-item">
                    <div className="row">
                      <div className="col">
                        <div className="card">
                          <img src="/IMG/perroSeccion3.jpg" className="card-img-top img-fluid" alt="Juanan" />
                          <div className="card-body">
      ...
      <section className="seccion4 mt-5">
        <div className="container">
          <div className="row">
