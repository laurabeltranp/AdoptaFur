          ...
          <div className="row">
            <div className="col-md-6">
              <div className="info">
                ...
                <p>Somos una organización dedicada a la búsqueda de personas que estén interesadas en adoptar animales
                  desamparados y a conectarlas con protectoras que ofrezcan esos animales. </p>
              </div>
              ...
              <iframe
                  ...
                  width="600" height="324" allowFullScreen="" loading="lazy"
                  referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <div className="col-md-6">
            <div className="form-box">
                <div className="text-center mb-3">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="icono"
                       style={{'width': '38px'}}>
                    <path fill="#000000"
