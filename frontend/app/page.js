            ...
            <div className="col-md-3">
              <div className="card h-100 tarjeta-background">
                ...
                <div className="card-body">
                  <h5 className="card-title nombre-animal">
                    <a
                      href="descripcion_perro.html"
            ...
            <div className="col-md-3">
              <div className="card h-100 tarjeta-background">
                ...
                <div className="card-body">
                  <h5 className="card-title nombre-animal">
                    <a
                      href="descripcion_periquito.html"
                      style={{ textDecoration: "none" }}
                    >
                      Capitán
                    </a>
        ...
        >
          <defs>
            <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop
                offset="0%"
                style={{ "stop-color": "rgb(88,213,92)", "stop-opacity": "0" }}
              />
              <stop
                offset="100%"
                style={{ "stop-color": "rgb(88,213,92)", "stop-opacity": "1" }}
              />
            </linearGradient>
            <linearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              <stop
                offset="100%"
                style={{ "top-color": "rgb(177,215,182)", "stop-opacity": "1" }}
              />
            </linearGradient>
          </defs>
          <path
            ...
            <div className="col-md-6">
              <div className="info">
                ...
                <p>
                  ...
                  Nuestro objetivo es facilitar el proceso de adopción y
                  promover el cuidado responsable de los animales.
                </p>
              </div>
            </div>
            <div className="col-md-6">
